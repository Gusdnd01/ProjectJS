...
private:
	...
	vector<platforms> m_vStagePlatforms = {
		...
		{ 89, Vec2(450.0f, -1680.0f), Vec2(100.0f, 100.0f)},//3�� (-1800)
		{ 75, Vec2(325.0f, -1950.0f), Vec2(50.0f, 70.0f)},
		...
		//3층 시작
		//3-1
		{177, Vec2{-600.0f, -4000.0f}, Vec2(210.0f, 70.0f)},
		{177, Vec2(0.0f, -4000.0f), Vec2(200.0f, 70.0f)},
		{177, Vec2(550.0f, -4000.0f), Vec2(400.0f, 70.0f)},
		{177, Vec2(-300.0f, -4300.0f), Vec2(75.0f, 75.0f)},
		//3-2
		{177, Vec2(-475.0f, -4500.0f), Vec2(100.0f)}, //위에 아이템 둬야함
		{177, Vec2(600.0f, -4500.0f), Vec2(75.0f)},//
		{177, Vec2(300.0f, -4750.0f), Vec2(100.0f, 50.0f)},//
		//3-3
		{177, Vec2(600.0f, -5050.0f), Vec2(200.0f, 50.0f)},//
		{177, Vec2(-200.0f, -5050.0f), Vec2(300.0f, 50.0f)},//
		{177, Vec2(-450.0f, -5250.0f), Vec2(75.0f, 75.0f)},
		{177, Vec2(-100.0f, -5450.0f), Vec2(75.0f, 75.0f)},
		{177, Vec2(400.0f, -5650.0f), Vec2(400.0f, 50.0f)},
		{177, Vec2(-600.0f, -5650.0f), Vec2(50.0f, 50.0f)},
		//3-4
		{177, Vec2(-500.0f, -5850.0f), Vec2(50.0f, 50.0f)},
		{177, Vec2(-400.0f, -5950.0f), Vec2(50.0f, 50.0f)},
		{177, Vec2(-300.0f, -6050.0f), Vec2(50.0f, 50.0f)},
		{177, Vec2(-200.0f, -6150.0f), Vec2(50.0f, 50.0f)},
		{177, Vec2(-100.0f, -6250.0f), Vec2(50.0f, 50.0f)},
		{177, Vec2(0.0f, -6350.0f), Vec2(50.0f, 50.0f)},
		{177, Vec2(100.0f, -6450.0f), Vec2(50.0f, 50.0f)},
		{177, Vec2(200.0f, -6550.0f), Vec2(50.0f, 50.0f)},
	};
